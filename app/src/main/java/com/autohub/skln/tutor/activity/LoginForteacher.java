...
import static com.autohub.skln.tutor.activity.TutorSignupStart.encrypt;

public class LoginForTutor extends AppCompatActivity {

    /*Declaration of Variables*/
    private static final String TAG = "LoginForTutor";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_forTutor);
        ...
        final ProgressDialog dialog = ProgressDialog.show(LoginForTutor.this, "Loging in User",
                "Loading. Please wait...", true);
        dialog.show();
                if(mContactNo.getText().toString().equals("")){
                    dialog.dismiss();
                    Toast.makeText(LoginForTutor.this, R.string.enter_phone, Toast.LENGTH_SHORT).show();

                }else if(mPassword.getText().toString().equals("")){

                    dialog.dismiss();
                    Toast.makeText(LoginForTutor.this, R.string.enter_password, Toast.LENGTH_SHORT).show();
