...
//    private int width;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding.paymentDuration.setAdapter(new SpinnerAdapter(this, getResources().getStringArray(R.array.payment_duration), R.color.blue, false));
    }
...
//    }
    ...
    private static class SpinnerAdapter extends BaseAdapter {
        ...
        SpinnerAdapter(Context context, String[] data, @ColorRes int color, boolean allCaps) {
            mLayoutInflater = LayoutInflater.from(context);
            mData.addAll(Arrays.asList(data));
            mTextColor = color;
            isAllCaps = allCaps;
