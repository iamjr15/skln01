...
import com.netzwelt.tutormodule.databinding.DialogFragmentEditClassesBinding;
import com.netzwelt.tutormodule.databinding.ItemClassCheckboxBinding;
...
public class EditClassesDialogFragment extends BaseDialogFragment {
    ...
    private void updateData() {
        if ((mSelectedClasses.contains(AppConstants.CLASS_11)
                || mSelectedClasses.contains(AppConstants.CLASS_12))
                && CommonUtils.hasLowerClasses(mSelectedClasses,
                new CommonUtils.Function<HashSet<String>>() {
            @Override
